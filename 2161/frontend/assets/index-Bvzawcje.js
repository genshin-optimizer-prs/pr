...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,F=`interface IWeapon {
  ...
  = ${[...new Set(P)].sort().map(b=>`"${b}" //${o(`charNames_gen:${I(s.chars.LocationToCharacterKey(b),i)}`)}`).join(`
