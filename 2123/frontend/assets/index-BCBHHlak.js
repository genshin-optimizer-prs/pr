...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,F=`interface IWeapon {
  ...
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"StatKey"}),e(n,{children:e(r,{children:e(l,{text:i})})})]})}function Z(){const{t:o}=y("artifactNames_gen"),s=`type ArtifactSetKey
  = ${[...new Set(G)].sort().map(i=>`"${i}" //${o(`artifactNames_gen:${i}`)}`).join(`
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"ArtifactSetKey"}),e(n,{children:e(r,{children:e(l,{text:s})})})]})}function Q(){const{t:o}=y("charNames_gen"),s=$(),{gender:i}=T(),p=`type CharacterKey
  = ${[...new Set(P)].sort().map(b=>`"${b}" //${o(`charNames_gen:${W(s.chars.LocationToCharacterKey(b),i)}`)}`).join(`
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"CharacterKey"}),e(n,{children:e(r,{children:e(l,{text:p})})})]})}function U(){const{t:o}=y("weaponNames_gen"),s=`type WeaponKey
